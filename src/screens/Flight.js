    ...
    return (
        ...
        <ScrollView vertical={true} style={{ height: 980, }}>
            <View style={{ paddingVertical: 20, flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20 }}>
                ...
                <Text style={{ color: 'bold', fontSize: 20, fontWeight: 'bold', textDecorationLine: 'Underline' }}>Flight Ticket Booking In Serampore
                </Text>
                <View>
                    <Image source={require("../images/flight.png")} style={{ height: 50, width: 50, borderRadius: 25 }}></Image>
                </View>
            </View>
            <Text style={{
                margin: 20,
